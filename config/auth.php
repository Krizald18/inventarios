...
return [
	...
	| options for your application. You may change these defaults as required, but
	...
	*/
	...
	| Of course, a great default configuration has been defined for you here which
	...
	| are actually retrieved out of your database or other storage mechanisms used
	...
	*/
	...
	|-----------------------------------------------------------------------------
	|
	| Here you may set the options for resetting passwords including the view that
	| is your password reset e-mail. You may also set the name of the table that
	| maintains all of the reset tokens for your application.
	|
	| You may specify multiple password reset configurations if you have more than
	| one user table or model in the application and you want to have separate
