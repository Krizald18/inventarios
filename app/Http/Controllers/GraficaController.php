...
class GraficaController extends Controller {
  ...
  public function activos() {
    ...
    $febrero = $mn >= 2 ?
      ($febrero[0]->value == 0 ? null : $febrero[0]->value) : null;
    $marzo = $mn >= 3 ?
      ($marzo[0]->value == 0 ? null : $marzo[0]->value) : null;
    $abril = $mn >= 4 ?
      ($abril[0]->value == 0 ? null : $abril[0]->value) : null;
    $mayo = $mn >= 5 ?
      ($mayo[0]->value == 0 ? null : $mayo[0]->value) : null;
    $junio = $mn >= 6 ?
      ($junio[0]->value == 0 ? null : $junio[0]->value) : null;
    $julio = $mn >= 7 ?
      ($julio[0]->value == 0 ? null : $julio[0]->value) : null;
    $agosto = $mn >= 8 ?
      ($agosto[0]->value == 0 ? null : $agosto[0]->value) : null;
    $septiembre = $mn >= 9 ?
      ($septiembre[0]->value == 0 ? null : $septiembre[0]->value) : null;
    $octubre = $mn >= 10 ?
      ($octubre[0]->value == 0 ? null : $octubre[0]->value) : null;
    $noviembre = $mn >= 11 ?
      ($noviembre[0]->value == 0 ? null : $noviembre[0]->value) : null;
    $diciembre = $mn >= 12 ?
      ($diciembre[0]->value == 0 ? null : $diciembre[0]->value) : null;
    $result = array_map(function($value) {
        return is_array($value) ?
          array("value" => $value["value"]) : array("value" => $value);
      }, compact('enero','febrero','marzo','abril','mayo','junio','julio',
